...
using System.IO;
public class SuiteInvalidPasswordTests : IDisposable
{
    public IWebDriver driver { get; private set; }
    public IDictionary<String, Object> vars { get; private set; }
    public IJavaScriptExecutor js { get; private set; }
    private dynamic credentials;
    public SuiteInvalidPasswordTests(bool isTestAll = false)
    {
        if (!isTestAll)
        {
            try
    ...
    public void RunTests()
    {
        ...
        foreach (var cred in credentials.invalidPassword)
        {
            InvalidPassword((string)cred.username, (string)cred.password);
    ...
    private void InvalidPassword(string username, string password)
    {
        try
        {
